...
function init(bundle, parent, options = {}) {
  ...
  const leftPanel = new Surface(300, 1000, Surface.SurfaceShape.Flat);
  leftPanel.setAngle(-0.6, 0);
  const rightPanel = new Surface(300, 600, Surface.SurfaceShape.Flat);
  rightPanel.setAngle(0.6, 0);

  // // Render your app content to the default cylinder surface
  // r360.renderToSurface(r360.createRoot("Hello360"), r360.getDefaultSurface());
  ...
  r360.compositor.setBackground("./static_assets/29348329641_35b194bf65_o.jpg");
}
